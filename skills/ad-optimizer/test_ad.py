...
class TestAdOptimizer:
    ...
    def test_metrics_update(self):
        ...
        success = self.optimizer.update_metrics(campaign.campaign_id, {})
        ...
        self.assert_equal(round(updated_campaign.metrics['ctr'], 3), 0.05, "CTR计算正确")
        self.assert_equal(round(updated_campaign.metrics['conversion_rate'], 3), 0.05, "转化率计算正确")
    ...
    def test_roi_analysis(self):
        ...
        self.optimizer.update_metrics(campaign.campaign_id, {'impressions': 50000, 'clicks': 2500, 'conversions': 125, 'cost': 5000, 'revenue': 15000})
    ...
    def test_roi_report(self):
        ...
        self.optimizer.update_metrics(campaign.campaign_id, {'impressions': 20000, 'clicks': 1000, 'conversions': 50, 'cost': 2000, 'revenue': 4000})
        
        camp2 = self.optimizer.create_campaign(account.account_id, "广告B", 3000)
        self.optimizer.update_metrics(campaign.campaign_id, {'impressions': 10000, 'clicks': 300, 'conversions': 10, 'cost': 1000, 'revenue': 500})
        ...
        self.assert_equal(round(summary['total_roi'], 2), 1.5, "总ROI正确")
    ...
    def test_ab_testing(self):
        ...
        # 测试2: 记录变体结果
        self.optimizer.record_variant_result(test.test_id, "A",
                                             impressions=5000, clicks=250, conversions=12)
        self.optimizer.record_variant_result(test.test_id, "B",
                                             impressions=5000, clicks=280, conversions=15)
        self.optimizer.record_variant_result(test.test_id, "C",
                                             impressions=5000, clicks=230, conversions=10)
    ...
    def test_auto_optimize(self):
        ...
        self.optimizer.update_metrics(campaign.campaign_id, {'impressions': 20000, 'clicks': 1000, 'conversions': 100, 'cost': 1000, 'revenue': 5000})

        camp_low = self.optimizer.create_campaign(account.account_id, "低ROI广告", 5000)
        self.optimizer.update_metrics(campaign.campaign_id, {'impressions': 10000, 'clicks': 200, 'conversions': 5, 'cost': 2000, 'revenue': 500})
    ...
    def test_optimization_suggestions(self):
        ...
        # 创建低ROI广告数据
        self.optimizer.update_metrics(campaign.campaign_id, {'impressions': 10000, 'clicks': 50})
